...
class MultifieldViewsHandler extends views_handler_field {
  ...
  function init(&$view, &$options) {
    ...
    $this->fieldHandler = new views_handler_field_field();
    $this->fieldHandler->init($view, $options);

    $this->field_info = $field = field_info_field($this->definition['field_name']);
    $this->subfield_info = $subfield = field_info_field($this->definition['subfield_name']);
    $this->multiple = FALSE;
